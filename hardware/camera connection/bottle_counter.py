...
Count the number of saline bags or bottles (IV fluid bags, saline bags, water bottles, liquid containers, or similar hospital supply items) on each side of the green straw.
...
If you cannot see the green straw, split the frame visually down the middle and note that no divider was detected. If no bottles are visible, return 0 for both."""
